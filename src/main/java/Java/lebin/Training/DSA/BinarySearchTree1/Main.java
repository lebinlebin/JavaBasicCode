...
import Java.lebin.Training.DSA.BinarySearchTree1.file.Files;
import Java.lebin.Training.DSA.BinarySearchTree1.printer.BinaryTreeInfo;
import Java.lebin.Training.DSA.BinarySearchTree1.printer.BinaryTrees;
...
public class Main {
	...
	static void test2() {
		...
		BinaryTrees.println((BinaryTreeInfo) bst1);
		...
		BinaryTrees.println((BinaryTreeInfo) bst2);
	}
	...
	static void test3() {
		...
		String str = BinaryTrees.printString((BinaryTreeInfo) bst);
		str += "\n";
